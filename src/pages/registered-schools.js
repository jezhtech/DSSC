...
const[schools]=useCollectionData(db.collection("schools"))
 ...
 <div className="">
    <div className="row row-cols-1 row-cols-sm-2 row-cols-md-4">{schools && schools.map(school => 
 {
        return( 
          <div className="col p-2">
        <div className="card border border-1 rounded-3 bg-light">
       <img src={school.logo} className="card-img-top" alt="logo"/>
